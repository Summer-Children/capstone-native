...
import { buttonTextVariants, buttonVariants } from 'reusables/components/ui/button'
...
const AlertDialogHeader = ({ className, ...props }: ViewProps): ReactNode => (
    <View className={cn('flex flex-col gap-2', className)} {...props} />
)
AlertDialogHeader.displayName = 'AlertDialogHeader'

const AlertDialogFooter = ({ className, ...props }: ViewProps): ReactNode => (
