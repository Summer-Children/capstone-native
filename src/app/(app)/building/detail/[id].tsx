...
export default function BuildingDetail(): ReactNode {
    ...
    const { data } = useQuery<{ res: Building }, { id: string }>(GET_BUILDING, {
    ...
    // const hasAssessments = building.assessmentReports.length > 0
    // const hasDraft = building.assessmentReports.some(report => report.draft === true)
        ...
        <>
            <Stack.Screen
                options={{
                    ...
                    headerRight: () => (
                        <TouchableOpacity
                            onPress={() => router.push(`/building/edit/${id}`)}
                            style={{
            ...
            <ScrollView>
                ...
                {/* {!hasAssessments && (
                    <TouchableOpacity
                        onPress={() => router.push(`../assessment/${building?.name}/assessment`)}
