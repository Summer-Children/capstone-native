...
export type TranscribeAudioMutation = { __typename?: 'Mutation', transcribeAudio: string };
...
export type GetComponentReportQuery = { __typename?: 'Query', componentReport: { __typename?: 'ComponentReport', id: string, componentId: string, assessmentReportId: string, action?: string | null, condition?: string | null, priority?: ComponentReportPriority | null, note?: string | null, quantityNeeded?: number | null, yearReviewed?: number | null, images: Array<{ __typename?: 'File', id: string, url: string } | null>, component: { __typename?: 'Component', name: string, unitRate?: number | null, actionFrequency?: number | null, nextActionYear?: number | null, lastActionYear?: number | null, yearInstalled?: number | null } } };
...
export type GetComponentReportsQuery = { __typename?: 'Query', componentReports: Array<{ __typename?: 'ComponentReport', id: string, componentId: string, action?: string | null, condition?: string | null, priority?: ComponentReportPriority | null, note?: string | null, quantityNeeded?: number | null, yearReviewed?: number | null, assessmentReportId: string, component: { __typename?: 'Component', name: string, unitRate?: number | null, actionFrequency?: number | null, nextActionYear?: number | null, lastActionYear?: number | null, yearInstalled?: number | null } } | null> };
...
export const TranscribeAudioDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"TranscribeAudio"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"TranscribeAudio"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transcribeAudio"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<TranscribeAudioMutation, TranscribeAudioMutationVariables>;
