...
export type GetAssessmentReportQuery = { __typename?: 'Query', res: { __typename?: 'AssessmentReport', id: string, fiscalYear: number, draft: boolean, building: { __typename?: 'Building', id: string, name?: string | null, crfAnnualContribution?: number | null, crfMinimumBalance?: number | null, crfTotalBalance?: number | null, components: Array<{ __typename?: 'Component', name: string, unitRate?: number | null, nextActionYear?: number | null, actionFrequency?: number | null } | null> } } };
